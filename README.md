...
### 🚀 About Me
- 🎓 Currently pursuing my **Bac+2 in IT**.
- 🛠️ Completed an introductory internship at **COBOMI (NABC - Coca-Cola)**.
- 🔐 Certified in **Cisco Introduction to Cybersecurity**.
- 💻 I enjoy building everything from desktop games to web-based management systems.
...
### 📂 Featured Projects
* **Student Attendance System:** A web app utilizing QR codes for real-time tracking (PHP/JS).
